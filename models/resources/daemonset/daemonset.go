...
func (d *daemonSetGetter) compare(left runtime.Object, right runtime.Object, field query.Field) bool {
	...
	return resources.DefaultObjectMetaCompare(leftDaemonSet.ObjectMeta, rightDaemonSet.ObjectMeta, field)
}
...
func (d *daemonSetGetter) filter(object runtime.Object, filter query.Filter) bool {
	...
	default:
		return resources.DefaultObjectMetaFilter(daemonSet.ObjectMeta, filter)
	}
}
