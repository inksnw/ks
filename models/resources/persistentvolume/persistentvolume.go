...
func New(informer informers.SharedInformerFactory) resources.Interface {
...
func (p *persistentVolumeGetter) List(namespace string, query *query.Query) (*api.ListResult, error) {
	...
	return resources.DefaultList(result, query, p.compare, p.filter), nil
}
...
func (p *persistentVolumeGetter) compare(obj1, obj2 runtime.Object, field query.Field) bool {
	...
	return resources.DefaultObjectMetaCompare(pv1.ObjectMeta, pv2.ObjectMeta, field)
}
...
func (p *persistentVolumeGetter) filter(object runtime.Object, filter query.Filter) bool {
	...
	default:
		return resources.DefaultObjectMetaFilter(pv.ObjectMeta, filter)
	}
}
